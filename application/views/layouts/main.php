...
<head>
  ...
  <title>{Outlet Automation Systems}</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
  <!-- Bootstrap 3.3.5 -->
  <link rel="stylesheet" href="<?php echo base_url('bower_components/AdminLTE/bootstrap/css/bootstrap.min.css') ?>">
  <!-- Font Awesome -->
...
<!-- FastClick -->
<script src="<?php echo base_url('bower_components/AdminLTE/plugins/fastclick/fastclick.js') ?>"></script>
<!-- AdminLTE App -->
